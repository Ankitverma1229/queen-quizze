...
import Validation from "../../components/Signup/Validation.js";
import axios from "axios";
import { useNavigate, Link } from "react-router-dom";
import Swal from "sweetalert2";
import { BsEye } from "react-icons/bs";
import { BsEyeSlash } from "react-icons/bs";
import girlImage from "../../assets/signup/signup_left.png";
...
const Signup = () => {
  ...
  function handleValidation(e) {
    ...
    if (
      ...
      axios
        .post("http://localhost:6500/api/admin/register", {
          ...user,
          userType: "Client",
        })
        .then((response) => {
  ...
  return (
    <div className=" md:w-[100vw] md:flex justify-center items-center mx-auto min-h-[90vh] my-10">
      <div className="flex min-h-[60%] md:min-h-[70%] lg:h-[90%] bg-white lg:w-[85vw] xl:w-[80vw] mx-auto rounded-xl">
        ...
        <div className="signup-form  md:w-[50%] md:ps-10  text-center md:text-start mt-0 md:mt-10">
          <div className="flex items-center justify-evenly md:justify-start md:gap-4  border-black mt-6">
            <p className="text-grey text-3xl font-publicSan font-[400]">
          ...
          <div className="mt-4  lg:mt-6 xl:mt-20  flex flex-col gap-4 mx-5 md:mx-0">
            <h2 className="text-grey font-publicSans  font-bold text-xl lg:text-3xl ">
              Sign Up
            </h2>
            <p className="text-sm lg:text-lg md:w-[80%] text-[#21262C] mx-auto md:mx-0 font-publicSans font-[500]">
          ...
          <div className="mt-3 xl:mt-14 md:w-[85%] lg:w-[90%] text-start px-3 md:px-0">
            <form
              method="POST"
            ...
            >
              <div>
                <label
                  htmlFor="name"
                  className="text-[#85909B] text-base font-[600]"
                >
                  Name
                </label>
                <input
              ...
              <div className="">
                <label
                  htmlFor="email"
                  className="text-[#85909B] w-full font-[600]"
                >
                  Email Address
                </label>
                <input
              ...
              <div className="">
                <label htmlFor="password" className="text-[#85909B] font-[600]">
                  Password
                </label>
              ...
              <div className="">
                <label
                  ...
                  className="text-[#85909B] font-[600]"
                >
                  Confirm Password
                </label>
                <div className="  md:px-2 flex  items-center w-[100%] bg-[#F7F8FB] border-solid border-2 border-[#E2E3E8] rounded-lg">
              ...
              <div className="flex justify-center md:justify-end pb-2">
                <button
                  type="submit"
                  className="bg-green w-[90%] md:w-[40%] xl:w-[25%] text-[1rem] font-[600] md:py-4 md:px-5 py-3 text-white rounded"
                >
                  Sign Up
                </button>
              </div>
            ...
            <div className="flex justify-center ">
              <Link
                to={"/login"}
                className="text-[#85909B] font-publicSans my-10 text-base font-[600]"
              >
